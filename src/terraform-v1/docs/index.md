...
!!! Note
    このドキュメントはterraform-provider-sakuracloud v1を対象としています。  
    v2をご利用の場合は以下のドキュメントを参照してください。  
...
- [v1.11での変更点](upgrade_to_v1_11/)      
- [v1.14での変更点](upgrade_to_v1_14/)      
- [v1.15での変更点](upgrade_to_v1_15/)      
...
- データリソース:
    ...
    - [エンハンスドロードバランサ](configuration/resources/data/proxylb/)
